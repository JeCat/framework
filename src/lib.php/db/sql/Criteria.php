...
class Criteria extends SubStatement {
	...
	public function makeStatement($bFormat = false) {
		...
		foreach ( $this->arrExpressions as $express ) {
			if ($express instanceof Criteria) {
	...
	/**
	 * 把一个 Criteria 实例添加到条件集合中去.
	 * @param self 被添加的Criteria对象
	 * @return self 
	 */
	public function add(self $aOtherCriteria) {
		$this->arrExpressions [] = $aOtherCriteria;
		return $this;
	}
	
	/**
	 * 
	 * 创建一个新的Criteria对象并把它作为条件语句的一部分添加到方法调用者中
	 * @return self 被创建的Criteria对象
	 */
