...
{	
	...
	public function insertCategoryToPoint($nTarget=self::end)
	{
		...
		else
		{
			...
			$this->aModel[$sLftClm] = $nTarget ;
			$this->aModel[$sRgtClm] = $nTarget+1 ;
			$this->aModel->insert() ;
		}
	}
	...
	static private function addChildCategory(Model $aModelList,$nParentModelIndex,$nChildModelIndex)
	{		
