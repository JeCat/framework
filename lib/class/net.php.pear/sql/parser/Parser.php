...
namespace net\php\pear\sql\parser ;
 ...
 * @link      http://pear.php.net/package/Parser
...
class Parser
{
    ...
    // {{{ function Parser($string = null, $dialect = 'ANSI')
    /**
     * Constructor
     *
     * @param string $string the SQL query to parse
     * @param string $dialect the SQL dialect
     * @uses  Parser::setDialect()
     * @uses  Parser::$lexer      W to create it
     * @uses  Parser::$symbols    R
     * @uses  Parser::$lexeropts  R
     * @uses  Lexer        to create an Object
     * @uses  Lexer::$symbols W to set it
     * @uses  is_string()
     */
     ...
     * @uses  in_array()
     * @uses  Parser::$dialects   R
     * @uses  Parser::$types      W to set it
     * @uses  Parser::$functions  W to set it
     * @uses  Parser::$operators  W to set it
     * @uses  Parser::$commands   W to set it
     * @uses  Parser::$synonyms   W to set it
     * @uses  Parser::$symbols    W to set it
     * @uses  Parser::$lexeropts  W to set it
     * @uses  Parser::$parseropts W to set it
     * @uses  Parser::raiseError()
     */
    public function setDialect($dialect)
    {
        if (! array_key_exists($dialect, Dialect::$arrDialects)) {
            throw new Exception('Unknown SQL dialect:' . $dialect);
        }

        $dialect = Dialect::$arrDialects[$dialect] ;
     ...
     * @uses  Parser::$token      R
     * @uses  Lexer::$string   R
     * @uses  Lexer::$lineBegin R
     * @uses  Lexer::$stringLen R
     * @uses  Lexer::$lineNo   R
     * @uses  Lexer::$tokText  R
     * @uses  Lexer::$tokPtr   R
     */
     ...
     * @uses  Parser::isVal()
     * @uses  Parser::isFunc()
     * @uses  Parser::parseFunctionOpts()
     * @uses  Parser::parseCondition()
     ...
     * @uses  Parser::getTok()
     * @uses  Parser::raiseError()
     * @uses  Parser::getParams()
     * @uses  Parser::isFunc()
     * @uses  Parser::parseFunctionOpts()
     * @uses  Parser::parseCondition()
     * @uses  Parser::isReserved()
     * @uses  Parser::isOperator()
     * @uses  Parser::parseSelect()
     * @uses  Lexer::$tokText
     * @uses  Lexer::unget()
     * @uses  Lexer::pushBack()
     */
     ...
     * @uses  Parser::getTok()
     * @uses  Parser::parseSelect()
     * @uses  Parser::parseUpdate()
     * @uses  Parser::parseInsert()
     * @uses  Parser::parseDelete()
     * @uses  Parser::parseCreate()
     * @uses  Parser::parseDrop()
     * @uses  Lexer
     * @uses  Lexer::$symbols
     * @access  public
     */
    ...
    public function parse($string = null)
    {
        try {
            if (is_string($string)) {
                $this->initLexer($string);
            } elseif (! $this->lexer instanceof Lexer) {
